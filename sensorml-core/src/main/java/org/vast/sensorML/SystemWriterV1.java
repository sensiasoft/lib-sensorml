...
import org.vast.sweCommon.SweComponentWriterV1;
...
/**
 * <p>
 * System Writer for SensorML version 1.0
 * </p>
 *
...
public class SystemWriterV1 implements IXMLWriterDOM<SMLProcess>
{
    ...
    {
        dom.addUserPrefix("sml", OGCRegistry.getNamespaceURI(SMLUtils.SENSORML, "1.0.1"));
        return dom.createElement("sml:System");
    }
}
