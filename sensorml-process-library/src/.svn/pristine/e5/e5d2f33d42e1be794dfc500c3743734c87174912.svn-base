 ...
 *   parameter data from the process
 * @author Mike Botts
 * @date January 26, 2010
 * @version 2.0
 */
public class CSM_FrameCameraModel_Process2 extends DataProcess {
   ...
   AbstractDataComponent csmParams;
