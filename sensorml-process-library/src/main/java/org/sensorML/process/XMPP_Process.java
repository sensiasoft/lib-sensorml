...
public class XMPP_Process extends AbstractProcessImpl implements DataHandler
{
    ...
    {    
        ...
        {    		
    		...
    		// XMPP parameters 
    		xmppParametersData = (DataRecord) paramData.getComponent("xmppParameters");
    		...
    		dataRecordData = (DataRecord) paramData.getComponent("dataRecordParameters");
    		...
    		alertDataComponent = (DataRecord) outputData.getComponent("alert");
    		
    		reader = new SASAlertReader();
    		reader.setDataComponents(alertDataComponent);
			TextEncoding dataEncoding = new TextEncodingImpl(blockSeparator, tokenSeparator);
	...
	public void endDataAtom(DataComponent info, DataBlock data) {
        ...
        if (dataType != DataType.UTF_STRING && dataType != DataType.ASCII_STRING)
        {
            ...
            if (converter == null)
            {
                String uom = ((HasUom)info).getUom().getCode();
