...
/**
 * <p>
 * Converts euler angles and location vector to an homogeneous 4x4 pose matrix
 * </p>
 *
 * @author Alexandre Robin
 * @date Sep 2, 2005
 */
public class Pos2Matrix4_Process extends ExecutableProcessImpl
{
    ...
    public void init() throws SMLProcessException
    {
        try
        {
            ...
            DataRecord rotVector = (DataRecord)inputData.getComponent("orientation");
