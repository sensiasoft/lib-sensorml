...
public class LLAToPTZ_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
        try
        {
        	...
        	DataComponent targetData = inputData.getComponent("targetLocation");
            ...
            DataComponent cameraData = paramData.getComponent("cameraLocation");
            ...
            DataComponent zerosPTData = paramData.getComponent("referencePanLocation");
