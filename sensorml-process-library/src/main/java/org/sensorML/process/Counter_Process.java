...
public class Counter_Process extends ExecutableProcessImpl
{
    ...
    public void init() throws SMLProcessException
    {
        ...
        try
        {
            ...
            DataComponent group = inputData.getComponent("countingRange");
            ...
            DataComponent countOutput = outputData.getComponent("count");
    ...
    public void execute() throws SMLProcessException
    {
        ...
        if (done)
        {
            ...
            {
                ((DataRecordImpl)inputPassThrough).combineDataBlocks();
