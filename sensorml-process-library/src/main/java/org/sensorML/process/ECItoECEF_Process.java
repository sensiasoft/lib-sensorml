 ...
 * @date March 2, 2006
 */
public class ECItoECEF_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
        try
        {
            ...
            DataRecord eciVector = (DataRecord)inputData.getComponent("ECI_location");
            eciX = (DataValue) eciVector.getComponent("x");
            eciY = (DataValue) eciVector.getComponent("y");
            eciZ = (DataValue) eciVector.getComponent("z");
            
            // Outputs Mappings
            DataRecord ecfVector = (DataRecord)outputData.getComponent("ECEF_location");
