...
public class WMS_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
        ...
        {
            // Input mappings
            DataRecord input = (DataRecord)inputData.getComponent("bbox");
            ...
            // Output mappings
            output = (DataRecord)outputData.getComponent("imageData");
            ...
            // image data type
            DataArray imgRowData = (DataArray)outputImage.getElementType();
            DataRecord pixelData = (DataRecord)imgRowData.getElementType();
        ...
        try
        {
            ...
            DataRecord wmsParams = (DataRecord)paramData.getComponent("wmsOptions");
    ...
    public void switchBytes(){
        ...
        DataRecord pixArr = (DataRecord)pixel;
