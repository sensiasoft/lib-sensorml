...
import org.vast.data.DataRecord;
...
public class WCS_Process extends ExecutableProcessImpl
{
    ...
    public void init() throws SMLProcessException
    {
        ...
        try
        {
            ...
            // Output mappings
            output = (DataRecord)outputData.getComponent("coverageData");
        ...
        try
        {
            ...
            DataRecord wcsParams = (DataRecord)paramData.getComponent("wcsOptions");
