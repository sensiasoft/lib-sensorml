...
public class SOS_Process extends AbstractProcessImpl implements DataHandler
{
    ...
    protected DataRecord outputObsLocation;
    ...
    protected DataRecord sosParams;
    ...
    public void init() throws ProcessException
    {
        ...
        try
        {
            ...
            {
                input = (DataRecord)inputData.getComponent("bbox");
            ...
            {
                input = (DataRecord)inputData.getComponent("time");
            ...
            outputObsLocation = (DataRecord) outputObsInfo.getComponent("location");
            outputObsData = outputData.getComponent("observationData");
            
            // Read parameters mappings + values
            sosParams = (DataRecord)paramData.getComponent("sosOptions");
