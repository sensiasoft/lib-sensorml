...
public class ArrayBuilder_Process extends AbstractProcessImpl
{
    ...
    {       
        try
        {
            ...
            DataRecord arrayComponent = (DataRecord) inputData.getComponent("arrayComponent");
            inputIndex = (DataValue) arrayComponent.getComponent("index");
            inputComponent = arrayComponent.getComponent("data");

            DataRecord outputGroup = (DataRecord) outputData.getComponent("arrayData");
    ...
    public void execute() throws ProcessException
    {
        ...
        if (needInit)
        {
            ...
            ((DataRecord)outputData.getComponent(0)).combineDataBlocks();            
