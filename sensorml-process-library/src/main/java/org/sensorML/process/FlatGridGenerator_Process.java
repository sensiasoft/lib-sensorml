...
public class FlatGridGenerator_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
        try
        {
            ...
            // Output mappings
            DataRecord output = (DataRecord)outputData.getComponent("gridData");
        ...
        try
        {
            ...
            ((DataArrayImpl)outputGrid).setFixedSize(length);
            ((DataArrayImpl)outputGrid.getComponent(0)).setFixedSize(width);
