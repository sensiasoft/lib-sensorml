   ...
   */
   public void init() throws SMLProcessException {
      ...
      try {
         ...
         DataRecord ground = (DataRecord) inputData.getComponent("ground");
         ...
         DataRecord lens = (DataRecord) inputData.getComponent("lens");
         lens_Yc = (DataValue) lens.getComponent("Yc");
         lens_Xc = (DataValue) lens.getComponent("Xc");
         lens_Zc = (DataValue) lens.getComponent("Zc");
         DataRecord attitude = (DataRecord) inputData.getComponent("attitude");
         ...
         DataRecord pixel = (DataRecord) outputData.getComponent("pixel");
         ...
         DataRecord pixelGrid = (DataRecord) paramData.getComponent("pixelGrid");
         ...
         DataRecord principalPoint = (DataRecord) paramData.getComponent("principalPoint");
         principalPoint_x0 = (DataValue) principalPoint.getComponent("x0");
         principalPoint_y0 = (DataValue) principalPoint.getComponent("y0");
         DataRecord affine = (DataRecord) paramData.getComponent("affine");
         ...
         DataRecord radial = (DataRecord) paramData.getComponent("radial");
         ...
         DataRecord decentering = (DataRecord) paramData.getComponent("decentering");
