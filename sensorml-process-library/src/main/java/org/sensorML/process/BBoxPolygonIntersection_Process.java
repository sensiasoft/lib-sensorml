 ...
 * @date Jan 31, 2008
 */
public class BBoxPolygonIntersection_Process extends ExecutableProcessImpl {
   ...
   DataComponent boundingBoxData, footprintData, intersectionData, numberOfPointsData;
