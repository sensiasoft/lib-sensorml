...
public class CSM_FrameCameraModel_Process2 extends AbstractProcessImpl {
   ...
   public CSM_FrameCameraModel_Process2() {
   }

   DataComponent focalLengthData, pixelGridCharacteristicsData, principalPointCoordinatesData;
   DataComponent affineDistortionCoefficientsData, radialDistortionCoefficientsData; 
   DataComponent decenteringCoefficientsData;
   DataComponent pixelGridCoordinatesData, viewVectorData;
   DataComponent csmParams;
   ...
   double k1, k2, k3;
   double p1, p2;
   DataComponent pointsData;
   DataValue intersectionExistsData;
   DataComponent URLongitudeData, URLatitudeData, LLLongitudeData, LLLatitudeData;
      ...
      try {
    	...
    	// initialize outputs mapping
         ...
         // initialize parameters mapping
    	  csmParams = paramData.getComponent("csmFrameParameters");
    	  focalLengthData = csmParams.getComponent("focalLength");
    	  focalLength = focalLengthData.getData().getDoubleValue();
    	  
    	  pixelGridCharacteristicsData = csmParams.getComponent("pixelGridCharacteristics");
    	  ...
    	  principalPointCoordinatesData = csmParams.getComponent("principalPointCoordinates");
    	  ...
    	  affineDistortionCoefficientsData = csmParams.getComponent("affineDistortionCoefficients");
    	  ...
    	  radialDistortionCoefficientsData = csmParams.getComponent("radialDistortionCoefficients");
    	  ...
    	  decenteringCoefficientsData = csmParams.getComponent("decenteringCoefficients");
