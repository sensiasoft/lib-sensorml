    ...
    public void init() throws SMLProcessException
    {
        try
        {
            ...
            re = 6378137.0/1000;  // scale equatorial radius to km for sgp4
             ...
             DataRecord outputPosition = (DataRecord) outputData.getComponent("ECI_location");  
             ...
             DataRecord outputVelocity = (DataRecord) outputData.getComponent("ECI_velocity");
             ...
             DataRecord paramElements = (DataRecord) paramData.getComponent("elements");
