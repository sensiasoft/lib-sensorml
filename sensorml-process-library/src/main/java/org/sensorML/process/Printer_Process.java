...
public class Printer_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
        try
        {
        	...
        	LogDate = new DateTimeFormat().formatIso((double)System.currentTimeMillis()/1000.0, TimeZone);
 ...
 /**   public boolean canRun()
    ...
    protected void printHeader() {
    	...
    	for (int i=0; i<inputConnections.size(); i++){
            DataConnectionList IConnections = inputConnections.get(i);
            DataConnectionList OConnections = outputConnections.get(i);
