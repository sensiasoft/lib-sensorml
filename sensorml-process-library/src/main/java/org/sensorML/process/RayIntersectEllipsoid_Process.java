 ...
 * @date Sep 2, 2005
 */
public class RayIntersectEllipsoid_Process extends AbstractProcessImpl
{
    ...
    public void init() throws ProcessException
    {
    	try
        {
            ...
            DataRecord rayDirectionData = (DataRecord)inputData.getComponent("rayDirection");
            ...
            DataRecord intersectionData = (DataRecord)outputData.getComponent("intersection");
            ...
            DataRecord datumData = (DataRecord)paramData.getComponent("datum");
            if (datumData != null)
            {
